...
```
Quando o filtro é opcional, monte um objeto dinamicamente.

1. Crie um filtro base
2. Adicione propriedades apenas se elas existirem
3. Passe o objeto para o find()
